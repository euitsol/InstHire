    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('institute.job-post.create') }}" class="btn btn-sm btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    @include('institute.includes.action_buttons', [
                                        'menuItems' => [
                                            [
                                                'routeName' => 'institute.job-post.show',
                                                'params' => [$job->id],
                                                'icon' => 'bi-eye',
                                                'label' => 'View Details',
                                                'className' => 'btn-info'
                                            ...
                                            [
                                                'routeName' => 'institute.job-post.edit',
                                                'params' => [$job->id],
                                                'icon' => 'bi-pencil',
                                                'label' => 'Edit',
                                            ...
                                            [
                                                'routeName' => 'institute.job-post.destroy',
                                                'params' => [$job->id],
                                                'icon' => 'bi-trash',
                                                'label' => 'Delete',
                                            ...
                                            // [
                                            //     'routeName' => 'institute.job-post.status-change',
                                            //     'params' => [$job->id],
