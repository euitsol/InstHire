                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h2 class="card-title mb-0">{{ __('Create Subscription') }}</h2>
                            @include('admin.includes.button', [
                                'routeName' => 'sm.subscription.index',
                                'label' => 'Back',
                            ])
                        </div>
                        <form action="{{ route('sm.subscription.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" step="0.01" value="{{ old('price') }}" class="form-control" name="price" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" value="{{ old('validity') }}" class="form-control" name="validity" required>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <textarea class="form-control" name="description" rows="4" placeholder="Enter subscription description...">{{ old('description') }}</textarea>
